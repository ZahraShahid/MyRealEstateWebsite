              ...
              <div className="row go-top">
                <div className="col-lg-4 col-md-6">
                  <div className="single-product-wrap style-bottom">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/project/1.png"}
                        alt="img"
                      />
                    ...
                    <div className="product-details-inner">
                      ...
                      <p>
                        Lorem ipsum dolor consectetur iicing elit, sed do eius
                        Lorem ipsum dolo amet, costur adipisicing eiusmod.
                      </p>
                    </div>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-product-wrap style-bottom">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/project/2.png"}
                        alt="img"
                      />
                      <div className="product-wrap-details">
                        <div className="media">
                    ...
                    <div className="product-details-inner">
                      <h4>
                        <Link to="/property-details">Gorgeous Villa</Link>
                      </h4>
                      <ul className="meta-inner">
                        <li>
                          <img
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-product-wrap style-bottom">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/project/3.png"}
                        alt="img"
                      />
                      <div className="product-wrap-details">
                        <div className="media">
                    ...
                    <div className="product-details-inner">
                      <h4>
                        <Link to="/property-details">Daily Property</Link>
                      </h4>
                      <ul className="meta-inner">
                        <li>
                          <img
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-product-wrap style-bottom">
                    ...
                    <div className="product-details-inner">
                      <h4>
                        <Link to="/property-details">Beach Side House</Link>
                      </h4>
                      <ul className="meta-inner">
                        <li>
                          <img
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-product-wrap style-bottom">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/project/6.png"}
                        alt="img"
                      />
                      <div className="product-wrap-details">
                        <div className="media">
                    ...
                    <div className="product-details-inner">
                      <h4>
                        <Link to="/property-details">Gorgeous Hotel</Link>
                      </h4>
                      <ul className="meta-inner">
                        <li>
                          <img
