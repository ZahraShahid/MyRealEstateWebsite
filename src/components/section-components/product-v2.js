          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="single-category-product-wrap">
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/product/cat-1.png"}
                    alt="img"
                  />
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-category-product-wrap">
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/product/cat-2.png"}
                    alt="img"
                  />
                </div>
                <div className="single-category-product-details">
                  <h4>
                    <Link to="/property-details">Rose Cottage</Link>
                  </h4>
                  <Link className="btn btn-base" to="/property">
                    6 Porparties
                  </Link>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-category-product-wrap">
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/product/cat-3.png"}
                    alt="img"
                  />
                </div>
                <div className="single-category-product-details">
            ...
            <div className="col-lg-4 col-md-6 order-lg-12">
              <div className="single-category-product-wrap">
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/product/cat-5.png"}
                    alt="img"
                  />
                </div>
                <div className="single-category-product-details">
            ...
            <div className="col-lg-8 order-lg-1">
              <div className="single-category-product-wrap">
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/product/cat-4.png"}
                    alt="img"
                  />
                </div>
                <div className="single-category-product-details">
