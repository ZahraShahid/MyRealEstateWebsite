...
const SubmittedPropertyRequestsSchema = new Schema(
  {
...
const SubmittedPropertyRequests = mongoose.model(
  "SubmittedPropertyRequests",
  SubmittedPropertyRequestsSchema
);
module.exports = SubmittedPropertyRequests;
